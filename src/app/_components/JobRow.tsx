...
export const JobRow = ({
  ...
  return (
    <Link href={`/jobs/${id}`}>
      <section className="flex h-auto w-full flex-col justify-between gap-4 rounded-lg border-b-4 border-genoa-500 bg-spring-rain-300 px-6 pb-6 pt-4 hover:cursor-pointer hover:bg-congress-blue-200">
